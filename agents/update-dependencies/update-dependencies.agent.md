...
GitHub Copilot will prompt for approval before running shell commands. This
is expected behavior — approve each command as prompted to allow the agent
to proceed through the workflow phases.
